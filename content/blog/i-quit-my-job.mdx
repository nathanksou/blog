...
<figure>
  ...
  <figcaption className="text-sm text-neutral-400 mt-2 text-center">
    <s>marty mauser</s> me chasing opportunity
  </figcaption>
</figure>
...
In two weeks I've pushed major updates to ghostwriter, built out an entire content engine from scratch, restructured how both studios operate, launched multiple sites including [Haku's Playground](https://playground.climbingcat.dev), redesigned my personal travel blog, and started planning what's next: roadmapping product features for existing products, building product requirements for niche markets we want to test in next, and learning distribution.
